...
vehicles.1997 <- vehicles.1997[order(vehicles.1997$hwy), ]
...
vehicles.20 <- vehicles[vehicles$drive == '2-Wheel Drive' & vehicles$cty > 20,]

# Of those vehicles, what is the vehicle ID of the vehicle with the worst hwy mpg?
# Hint: filter for the worst vehicle, then select its ID.
vehicle.worst <- vehicles.20$id[vehicles.20$hwy == min(vehicles.20$hwy)]
...
vehicle.best <- function(year, make) {
